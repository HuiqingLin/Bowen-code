...
def make_plot():
    ...
    for i in range(4):
        for j in range(3):
            ...
            axes[i][j].plot(dftemp['month'], dftemp['b'], linestyle='-', color='#4984b8',marker='o', markersize=2, linewidth=1.5,label = "N     N="+str(N))
    ...
    def DrawS(m,n,nam):
        ...
        axes[m][n].plot(dftemp['month'], dftemp['b'], linestyle='-', color='mediumturquoise',marker='o', markersize=2, linewidth=1.5,label = "S     N="+str(N))
    ...
    #axes[3][1].set_yticks([-6,-3,0,3])

    axes[0][0].text(0.5,2.9,'(a)',fontsize=11)
    ...
    axes[2][0].text(0.18,4.25,'(g)',fontsize=11)
    axes[2][1].text(0.5,5.28,'(h)',fontsize=11)
    axes[2][2].text(0.5,4.55,'(i)',fontsize=11)
    axes[3][0].text(0.2,5.39,'(j)',fontsize=11)
    axes[3][1].text(0.2,1.54,'(k)',fontsize=11)
    axes[3][2].text(0.2,1.034,'(l)',fontsize=11)

    axes[0][0].legend(loc=1,frameon=False,fontsize=6.5,bbox_to_anchor=(0.93,0.85))
    axes[0][1].legend(loc=1,frameon=False,fontsize=6.5,bbox_to_anchor=(0.93,0.2))
    axes[0][2].legend(loc=1,frameon=False,fontsize=6.5,bbox_to_anchor=(0.93,0.85))
    axes[1][0].legend(loc=1,frameon=False,fontsize=6.5,bbox_to_anchor=(0.93,0.85))
    axes[1][1].legend(loc=1,frameon=False,fontsize=6.5,bbox_to_anchor=(0.93,0.205))
    axes[1][2].legend(loc=1,frameon=False,fontsize=6.5,bbox_to_anchor=(0.93,0.85))
    axes[2][0].legend(loc=1,frameon=False,fontsize=6.5,bbox_to_anchor=(0.93,0.85))
    axes[2][1].legend(loc=1,frameon=False,fontsize=6.5,bbox_to_anchor=(0.93,0.2))
    axes[2][2].legend(loc=1,frameon=False,fontsize=6.5,bbox_to_anchor=(0.93,0.2))
    axes[3][0].legend(loc=1,frameon=False,fontsize=6.5,bbox_to_anchor=(0.93,0.92))
    axes[3][1].legend(loc=1,frameon=False,fontsize=6.5,bbox_to_anchor=(0.93,0.92))
    axes[3][2].legend(loc=1,frameon=False,fontsize=6.5,bbox_to_anchor=(0.93,0.85))
