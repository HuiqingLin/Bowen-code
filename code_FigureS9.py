...
def make_plot():
    df_site= pd.read_csv("../data/processed_data/各点多年平均_去2站点.csv")
    ...
    df_pftmax=xr.open_dataset("../data/processed_data/CLM_pftmax.nc")
    ...
    (c,s)=plot_fitting(df_CLM_extract1,'albedo','b',axes,order=1,lw=1.5,color='k',fontsize=10)
    ...
    plt.savefig("../data/processed_data/figure/Figure S9.png",dpi=600,bbox_inches='tight')
    print("finished!")
